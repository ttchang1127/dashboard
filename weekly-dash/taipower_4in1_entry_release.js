(function(){
  ...
  const formDefs=[
    ["f01","進場前送審文件總表／公文追蹤","公司自製"],["f02","監造計畫審查意見回覆與版本管制表","公司自製"],["f03","人員資格送審封面及個人附件檢核表","公司自製"],["f04","人員異動及新舊資格比較表","公司自製"],["f05","115年9月出勤配置計畫／每日排班表（含車輛附件）","公司自製"],["f06","名冊、資格、投保、配置、簽到五表勾稽表","公司自製"],["f07","12小時職前訓練計畫及課程表","公司自製"],["f08","12小時職前訓練出席、照片、測驗及結訓紀錄","公司自製"],["f09","PPE需求、領用與適用性檢點表","公司自製"],["f10","車輛配置計畫、核備及車月證據表","公司自製"],["f11","工務所設備、通訊及緊急聯絡檢點表","公司自製"],["f12","D-1正式派駐放行表","公司自製"],["f13","115/09/01進場首日紀錄","公司自製"],["f14","正式派駐門檻未齊之限定前置作業書面指示紀錄","公司自製"],
